...
function setupExp(){
  ...
  socket.on('onConnected', function(d) {
    ...
    var instructionsHTML = {
      ...
      'str3':"<p style = 'font-size:24px;line-height:1.5;'> Here's how you label a sketch! <p style = 'font-size:30px;line-height:1.5;'> 1. You can click on a stroke OR paint over it by dragging your cursor over several strokes.\
      ...
      'str4': "<p style = 'font-size:24px;line-height:1.5;'> Okay, let's practice! Make sure to familiarize yourself with the task.</p><p style = 'font-size:30px;line-height:1.5;'>Click on 'next sketch' when you're done labeling.</p>"}
      ...
      trials[2] ={
        ...
        '<p style = "font-size:30px;line-height:1.5;">Please pay attention and do your best! Thank you!</p>'],
        show_clickable_nav: true
      }
