...
function setupExp(){
  ...
  socket.on('onConnected', function(d) {
    ...
    var instructionsHTML = {
      'str1' :"<p style = 'font-size:24px;line-height:1.5;'> In this HIT you will play a fun game where you will see some sketches and tell us what you see!<p style = 'font-size:24px;line-height:1.5;'>Each sketch was made by somebody who was playing a Pictionary-style game, in which they had to make a sketch of a target object (outlined in red) so that someone else could tell which object in the set they were trying to draw.<p style = 'font-size:24px;line-height:1.5;'><img src = 'instructions1.png' style='border: 2px solid #000000;'></img><p> <br> <br> </p></p>\
      <p style = 'font-size:24px;line-height:1.5;'>Your goal is to label each of the strokes in these sketches by selecting parts from a menu.</p></p></p>",
      'str2':"<p style = 'font-size:24px;line-height:1.5;'> Let's walk through an example! Please carefully review the diagram below:<p><img src= 'instructions2.png' style= 'height:650px;border: 2px solid #000000;'></img><p> <br> <br> </p></p></p>",
      'str3':"<p style = 'font-size:30px;line-height:1.5;'> Here's how you label a sketch! <p style = 'font-size:24px;line-height:1.5;'> 1. You can click on a stroke OR paint over it by dragging your cursor over several strokes.\
      Once it is selected, it will turn light-gray.<p style = 'font-size:24px;line-height:2;'><img src = 'instructions3.png' style='height:350px; width:1050px; border: 2px solid #000000; '></img></p><p style= 'line-height:2;'><img src = 'instructions4.png' style='height:350px; width:1050px;border: 2px solid #000000;'></img><p> <br> <br> </p></p><p style = 'font-size:24px;line-height:1.5;'> 2. You then click on one of the labels in the righthand menu to label it. Once it is labeled,\
      it will turn into the same color as the word in the menu.<p style='line-height:2;'><img src ='instructions5.png' style='height:350px; width:1050px;border: 2px solid #000000;'></img><p> <br> <br> </p></p><p style = 'font-size:24px;line-height:1.5;'> 3. If the label you think is most appropriate for the stroke is not already \
      ...
      trials[2] ={
        ...
        '<p style = "font-size:24px;line-height:1.5;">You will receive both a bonus for every stroke you label AND a special "completion bonus" for labeling all the strokes in a sketch.</p>',
        ...
        '<p style = "font-size:24px;line-height:1.5;">We expect the average amount of time required to complete the HIT to be around 10 minutes, including the time it takes to read the instructions. By completing this HIT, you are participating in a study being conducted by cognitive scientists in the Stanford Department of Psychology. If you have questions about this research, or if you encounter a problem or error, please contact the <b>Sketchloop Admin</b> at <b><a href="mailto://sketchloop@gmail.com">sketchloop@gmail.com</a> </b> or Noah Goodman (n goodman at stanford dot edu) and we will make sure you are compensated for your time! You must be at least 18 years old to participate. Your participation in this research is voluntary. You may decline to answer any or all of the following questions. You may decline further participation, at any time, without adverse consequences. Your anonymity is assured; the researchers who have requested your participation will not receive any personal information about you.</p>',
        '<p style = "font-size:24px;line-height:1.5;">Please pay attention and do your best! Thank you!</p>'],
        show_clickable_nav: true
      }
