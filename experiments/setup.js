...
function setupExp(){
  ...
  socket.on('onConnected', function(d) {
    ...
    var instructionsHTML = {
      ...
      'str2':"<p style = 'font-size:24px;line-height:1.5;'> Let's walk through an example! See the diagram below:<p><img src= 'instructions2.png' style= 'height:650px;border: 2px solid #000000;'></img><p> <br> <br> </p></p></p>",
      'str3':"<p style = 'font-size:24px;line-height:1.5;'> Here's how you label a sketch! <p style = 'font-size:24px;line-height:1.5;'> 1. You can click on a stroke OR paint over it by dragging your cursor over several strokes.\
      ...
      'str4': "<p style = 'font-size:24px;line-height:1.5;'> Okay, let's practice! Make sure to familiarize yourself with the task.</p><p style = 'font-size:24px;line-height:1.5;'>Click on 'next sketch' when you're done labeling.</p>"}
