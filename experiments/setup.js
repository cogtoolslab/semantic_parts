...
function setupExp(){
  ...
  socket.on('onConnected', function(d) {
    ...
    var instructionsHTML = {
      ...
      it will turn into the same color as the word in the menu.<p style='line-height:2;'><img src ='instructions5.png' style='height:350px; width:1050px;border: 2px solid #000000;'></img><p> <br> <br> </p></p><p style = 'font-size:20px;line-height:1.3;'> 3. If the label you think is most appropriate for the stroke is not already \
      ...
      that stroke again, and select a new label from the menu.<p style='line-height:2;'><img src ='instructions7.png' style='height:350px; width:1050px;border: 2px solid #000000;'></img><p> <br> <br> </p></p> </p> <p style = 'font-size:20px;line-height:1.3;'> 5. Repeat steps 1–4 until you have labeled all the strokes in the sketch.</p>\
      <p style = 'font-size:20px;line-height:1.3;'>Note: To make your life easier, as you label more strokes in each sketch, the remaining ones will get thicker so it is easier to see them.</p> <p style='line-height:2;'><img src ='instructions8.png' style='height:350px;border: 2px solid #000000;'></img></p></p>",
